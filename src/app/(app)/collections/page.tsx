      ...
      <section className="relative h-64 bg-linear-to-r from-gold/20 to-cream flex items-center justify-center">
        <div className="container text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our complete range of handmade crochet pieces, each crafted with love and
            attention to detail. From cozy blankets to stylish accessories, find the perfect piece
